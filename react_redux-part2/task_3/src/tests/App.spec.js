...
// Mock data (new API shape with nested context).
const mockNotifications = [
  {
    id: '1',
    author: { id: 'u1', name: { first: 'Alice', last: 'A' }, email: 'a@b.com', picture: '', age: 25 },
    context: { guid: 'g1', isRead: false, type: 'default', value: 'New course available' },
  },
  {
    id: '2',
    author: { id: 'u2', name: { first: 'Bob', last: 'B' }, email: 'b@c.com', picture: '', age: 30 },
